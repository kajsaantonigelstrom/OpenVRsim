...
public:
    ...
    virtual EVRInitError Activate( vr::TrackedDeviceIndex_t unObjectId ) 
    {
        ...
        vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_InputProfilePath_String, "{virtualdevice}/input/virtualdevice_profile.json");
...
public:
    ...
    virtual EVRInitError Activate( vr::TrackedDeviceIndex_t unObjectId )
    {
        ...
        vr::VRProperties()->SetStringProperty( m_ulPropertyContainer, Prop_InputProfilePath_String, "{virtualdevice}/input/virtualdevice_profile.json" );
        ...
        /r::VRDriverInput()->CreateBooleanComponent( m_ulPropertyContainer, "/input/c/click", &m_compC );
